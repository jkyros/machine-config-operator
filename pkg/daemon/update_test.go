...
func TestCalculatePostConfigChangeAction(t *testing.T) {
	files := map[string]ign3types.File{
		...
		"fcos_authorized_keys":     ctrlcommon.NewIgnFile(fcosAuthKeyPath, "authorized_keys"),
		"non_fcos_authorized_keys": ctrlcommon.NewIgnFile(nonFCOSAuthKeyPath, "authorized_keys"),
	}
