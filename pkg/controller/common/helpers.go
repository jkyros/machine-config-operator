...
// GetDefaultBaseImageContainer is kind of a "soft feature gate" for using the "new format" image by default, it's behavior
...
func GetDefaultBaseImageContainer(cconfigspec *mcfgv1.ControllerConfigSpec) string {
	if UseNewFormatImageByDefault {
		return cconfigspec.BaseOperatingSystemContainer
	}
