...
func TestMergeDaemonSetUpdateStrategy(t *testing.T) {
	// The merge functions all set "modified" to true if pointer fields
	// are nil. Since this test doesn't "zero" all the pointer fields
	// it will always say that it was "modified", so this test
